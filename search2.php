...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <form method="get" action="search2.php">
                <input value="<?php echo $_GET['min'];?>" type="number" placeholder="Min" min="1" class="form-control" name="min">
             </div>
                
                <div class="col-sm-2">
                <input value="<?php echo $_GET['max'];?>" type="number" placeholder="Max" min="1" class="form-control" name="max">
                </div>
    ...
    <div class="listing-section">
        <div class="container">
            ...
            $min = $_GET['min'];
            $max = $_GET['max'];
            $sql = "select * from product where price between $min and $max   order by id desc";
            $result11 = mysqli_query($con, $sql);
            ...
            <div class="col-sm-4">
                    <div class="product">
                        <div class="image-box">
                            <br>
                            <div class="images" style="background-image: url('images/<?php echo $rows11['file'];?>');"></div>
                        </div>
                        <div class="text-box">
